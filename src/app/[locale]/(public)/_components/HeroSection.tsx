...
import {fadeInVariants, fadeMoveVariants} from "@/lib/animations/variants";
    ...
    return (
        <BentoContainer
            ...
            <motion.div
                ...
                custom={{customDelay: duration.short}}
            ...
            <motion.div
                ...
                custom={{customDelay: duration.short, startX: "var(--start-x)", startY: "var(--start-y)"}}
